import{_ as n,o as a,c as e,ai as p}from"./chunks/framework.CaiDwmc7.js";const m=JSON.parse('{"title":"Source Structure","description":"Complete file tree for the Electron desktop app, including main process, preload, office subsystem, and React SPA.","frontmatter":{"title":"Source Structure","description":"Complete file tree for the Electron desktop app, including main process, preload, office subsystem, and React SPA.","outline":[2,3]},"headers":[],"relativePath":"electron/source-structure.md","filePath":"electron/source-structure.md","lastUpdated":1772487797000}'),i={name:"electron/source-structure.md"};function l(r,s,t,c,o,b){return a(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="electron-source-structure" tabindex="-1">Electron Source Structure <a class="header-anchor" href="#electron-source-structure" aria-label="Permalink to “Electron Source Structure”">​</a></h1><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>cmd/prism-electron/</span></span>
