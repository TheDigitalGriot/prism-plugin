...
export const MATRIX_HEAD_COLOR = '#93C5FD'       // Light blue (Prism spectral)
export const MATRIX_TRAIL_BRIGHT = '#3B82F6'     // Prism blue
export const MATRIX_TRAIL_MID = '#1D4ED8'        // Mid blue
export const MATRIX_TRAIL_DIM = '#1E3A5F'        // Dark blue
