# Prism TUI - Complete Documentation
...
make build          # Build for current platform → bin/prism-tui
...
prism-tui .prism/stories/stories.json
...
prism-tui --onboarding

# With options
prism-tui -f stories.json -n 100 -p 5 --prism-style braille
```
...
```
  ...
  Welcome to Prism TUI! Let's set up your project.
...
│ ─────────────────────────────────────────────────────────────────────────── │
│ [14:32:05] INFO  Prism TUI v1.9.8                                          │
